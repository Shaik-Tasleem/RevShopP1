...
public class CategoryController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<Category> getCatById(@PathVariable int id){
		return new ResponseEntity<>(service.getCatBtId(id), HttpStatus.OK);
	}
	
	@PutMapping("/{id}")
	public ResponseEntity<Category> updateCat(@PathVariable int id, @RequestBody Category category){
		service.insertCategory(category);
